...
/**
 * This is the game model class that brings all the logic together for the game, here
 * it will check for when a word is placed that its adjacent to other words, is valid, etc.
 * Then it will send this information to the view via the controller to be updated for the players view.
 *
 * Author(s): Rami Ayoub
 * Version: 2.0
...
public class GameModel {
    ...
    /**
     * Initializes the list of players, the boards, the bag of tiles,
     * the list of words.
     */
    public GameModel() {
    ...
    /**
     * Creates a player in the game when given a player name and adds it to the
     * array list of players. Gives each player to start the game 7 random tiles
     * from the tiles bag.
     * @param playerName the name of the player
     */
    public void createPlayer(String playerName) {
        Player newPlayer = new Player(playerName); //creates a new player
        players.add(newPlayer); //adds the new player to the array list of players
        getRandomTiles(7, newPlayer); //assigns 7 random tiles for the new player
    }
    ...
    /**
     * Returns a specific player in the array list of players in the game
     * @re
     */
