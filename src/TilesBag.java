...
public class TilesBag {
    ...
    private HashMap<String, Integer> valueOfTiles; //represents the value of the tiles
    ...
    /**
     *returns the value of the tiles hashmap having each letter and its associated value
     */
